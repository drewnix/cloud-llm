# =============================================================================
# Dev Environment Stack - us-east-1
# =============================================================================
# This stack file defines the complete LLM infrastructure for the dev environment.
# It references reusable unit templates from units/ and passes environment-specific
# values. Terragrunt generates the actual configs and resolves dependencies.
#
# Deploy:  cd live/dev/us-east-1 && terragrunt stack run apply
# Destroy: cd live/dev/us-east-1 && terragrunt stack run destroy
# =============================================================================
